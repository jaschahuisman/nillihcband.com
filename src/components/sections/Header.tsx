...
import { FaArrowDown, FaFacebook, FaInstagram, FaSpotify, FaYoutube } from "react-icons/fa"
...
export default function Header() {
    ...
    useEffect(() => {
        ...
        desktopImg.src = "/images/hero-desktop.webp"
    ...
    return (
        <header className="relative text-primary-foreground mb-12">
            <div className="absolute overflow-x-hidden bottom-0 md:top-0 left-1/2 translate-y-1/2 md:translate-y-0 -translate-x-1/2 py-4  pointer-events-none z-10">
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <Image src="/images/logo-sm.jpg" alt="Nillihc band logo" width={40} height={40} className="w-full h-full object-cover animate-spin-slow" />
                        </motion.div>
                        <motion.a
                        ...
                        <motion.a
                            className="flex items-center justify-center p-2"
                            href="https://www.facebook.com/NillihcBand/"
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <motion.a
                            className="flex items-center justify-center p-2"
                            href="https://www.youtube.com/@nillihcband"
                            target="_blank"
                            rel="noopener noreferrer"
            ...
            <div className="min-h-[80vh] md:min-h-[calc(99vh)] relative w-full flex items-center overflow-hidden">
                ...
                <Image
                    src="/images/hero-desktop-placeholder.webp"
                    alt=""
                    fill
                ...
                <Image
                    src="/images/hero-mobile-placeholder.webp"
                    alt=""
                    fill
